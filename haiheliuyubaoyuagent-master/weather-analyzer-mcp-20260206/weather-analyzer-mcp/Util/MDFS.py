...
from Util.table import id_dtype, id_name
...
class Grid(MDFSFile):
    ...
    def to_xarray(self):
        ...
        return xr.DataArray(self.data['Grid'],
                            coords={'longitude': self.data['Lon'], 'latitude': self.data['Lat'], 'time': self.time},
                            dims=['latitude', 'longitude'],
                            attrs={'units': self.data_dsc, 'levels': self.level, 'name': self.element,
                                   'model_name': self.model_name, 'time_bounds': self.period,
                                   'initial_time': self.utc_time},
